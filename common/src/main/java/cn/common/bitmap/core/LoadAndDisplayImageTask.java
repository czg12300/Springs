...
import cn.common.bitmap.core.assist.ImageScaleType;
...
import cn.common.bitmap.core.decode.ImageDecodingInfo;
...
import cn.common.bitmap.core.listener.ImageLoadingProgressListener;
        ...
        try {
            ...
            if (bitmap == null || bitmap.getWidth() <= 0 || bitmap.getHeight() <= 0) {
                ...
                if (options.isCacheOnDisk() && tryCacheImageOnDisk()) {
                    ...
                    if (imageFile != null) {
                        imageUriForDecoding = ImageDownloader.Scheme.FILE
                                .wrap(imageFile.getAbsolutePath());
                    }
                }
    ...
    private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException {
        ...
        if (targetFile != null && targetFile.exists()) {
            ...
            DisplayImageOptions specialOptions = new DisplayImageOptions.Builder()
                    .cloneFrom(options).imageScaleType(ImageScaleType.IN_SAMPLE_INT).build();
            ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey,
                    ImageDownloader.Scheme.FILE.wrap(targetFile.getAbsolutePath()), uri,
                    targetImageSize, ViewScaleType.FIT_INSIDE, getDownloader(), specialOptions);

...
import cn.common.bitmap.cache.disc.impl.UnlimitedDiskCache;
import cn.common.bitmap.cache.disc.impl.ext.LruDiskCache;
import cn.common.bitmap.cache.disc.naming.FileNameGenerator;
import cn.common.bitmap.cache.disc.naming.HashCodeFileNameGenerator;
import cn.common.bitmap.cache.memory.MemoryCache;
import cn.common.bitmap.cache.memory.impl.LruMemoryCache;
import cn.common.bitmap.core.assist.QueueProcessingType;
import cn.common.bitmap.core.assist.deque.LIFOLinkedBlockingDeque;
import cn.common.bitmap.core.decode.BaseImageDecoder;
import cn.common.bitmap.core.decode.ImageDecoder;
import cn.common.bitmap.core.display.BitmapDisplayer;
import cn.common.bitmap.core.display.SimpleBitmapDisplayer;
import cn.common.bitmap.core.download.BaseImageDownloader;
import cn.common.bitmap.core.download.ImageDownloader;
import cn.common.bitmap.utils.L;
import cn.common.bitmap.utils.StorageUtils;
...
public class DefaultConfigurationFactory {
    ...
    public static Executor createExecutor(int threadPoolSize, int threadPriority,
        ...
        return new ThreadPoolExecutor(threadPoolSize, threadPoolSize, 0L, TimeUnit.MILLISECONDS,
                taskQueue, createThreadFactory(threadPriority, "uil-pool-"));
    }

    /** Creates default implementation of task distributor */
    public static Executor createTaskDistributor() {
        return Executors
                .newCachedThreadPool(createThreadFactory(Thread.NORM_PRIORITY, "uil-pool-d-"));
    }

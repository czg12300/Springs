...
public class TabRadioGroup extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         * {@link ViewGroup.LayoutParams#WRAP_CONTENT} and the child's height to
         * {@link ViewGroup.LayoutParams#WRAP_CONTENT} when not specified in the
         * XML file.
         * </p>
         * 
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == TabRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == TabRadioGroup.this && child instanceof ViewGroup) {

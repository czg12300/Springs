...
public class WorkListDetailActivity extends CommonTitleActivity {
  ...
  private void cancelTask() {
    HttpRequestManager<FinishWorkResponse> requestWG = new HttpRequestManager<FinishWorkResponse>(URLConfig.DETAIL_CANCEL, FinishWorkResponse.class);
  ...
  private void unFinishWorkTask() {
    HttpRequestManager<FinishWorkResponse> requestQH = new HttpRequestManager<FinishWorkResponse>(URLConfig.UN_FINISH_WORK, FinishWorkResponse.class);
  ...
  private void updateData(Message msg) {
    if (msg.obj != null && msg.obj instanceof WorkListDetailResponse) {
      ...
      if (mInfo != null) {
        ...
        if (TextUtils.equals(mInfo.getType(), WorkListInfo.TYPE_TAOCAN) || TextUtils.equals(mInfo.getType(), WorkListInfo.TYPE_XIAOTUI)) {
  ...
  private void showCancelDialog() {
    if (!isFinishing()) {
      if (mCancelDialog == null) {
        ...
        mCancelDialog.findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            if (mCancelDialog != null) {
        ...
        mCancelDialog.findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            if (mCancelDialog != null) {
              mCancelDialog.dismiss();
